...
export class KpiChartComponent {
  ...
  unitsMap: Map<string, string[]> = new Map<string, string[]>([
    ...
    [KPIEndpointKey.TOTAL_CONSUMPTION, ['kWh', 'mWh', 'gWh']],
    [ArtificialDatasetKey.TOTAL_CONSUMPTION, ['kWh', 'mWh', 'gWh']],
    [KPIEndpointKey.TOTAL_PRODUCTION, ['kWh', 'mWh', 'gWh']],
    [ArtificialDatasetKey.TOTAL_PRODUCTION, ['kWh', 'mWh', 'gWh']],
